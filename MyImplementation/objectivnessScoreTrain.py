...
model = keras.Sequential([
       tf.keras.layers.Conv2D(24, kernel_size=(3,3), padding='same',activation='leaky_relu',
                           input_shape=(256,256,3)),
    tf.keras.layers.MaxPooling2D(pool_size=(3,3)),
    tf.keras.layers.Conv2D(40, kernel_size=(3,3), padding='same',activation='leaky_relu'),
    tf.keras.layers.Conv2D(42, kernel_size=(3,3), padding='same',activation='leaky_relu'),
    tf.keras.layers.MaxPooling2D(pool_size=(2,2)),
    tf.keras.layers.Conv2D(120, kernel_size=(3,3), padding='same',activation='leaky_relu'),
    tf.keras.layers.Conv2D(100, kernel_size=(3,3), padding='same',activation='leaky_relu'),
    tf.keras.layers.MaxPooling2D(pool_size=(2,2)),
    tf.keras.layers.Conv2D(150, kernel_size=(3,3), padding='same',activation='leaky_relu'),
    tf.keras.layers.Conv2D(100, kernel_size=(3,3), padding='same',activation='leaky_relu'),
    tf.keras.layers.MaxPooling2D(pool_size=(2,2)),
    tf.keras.layers.Conv2D(200, kernel_size=(3,3), padding='same',activation='leaky_relu'),
    tf.keras.layers.Conv2D(100, kernel_size=(3,3), padding='same',activation='leaky_relu'),
    tf.keras.layers.MaxPooling2D(pool_size=(2,2)),
    tf.keras.layers.Conv2D(400, kernel_size=(3,3), padding='same',activation='leaky_relu'),
    tf.keras.layers.Conv2D(200, kernel_size=(3,3), padding='same',activation='leaky_relu'),
    tf.keras.layers.MaxPooling2D(pool_size=(2,2)),
